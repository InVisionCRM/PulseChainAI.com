...
const TokenInfoCard: React.FC<{ tokenInfo: TokenInfo | null }> = ({ tokenInfo }) => {
  if (!tokenInfo) {
    return (
      <div className="relative bg-slate-800/50 p-4 sm:p-6 rounded-xl shadow-lg border border-slate-700 h-full flex items-center justify-center">
  ...
  return (
    <div className="relative bg-slate-800/50 p-4 sm:p-6 rounded-xl shadow-lg border border-slate-700">
      <GlowingEffect disabled={false} glow={true} />
