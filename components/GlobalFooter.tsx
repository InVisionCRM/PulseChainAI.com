...
export default function GlobalFooter() {
  ...
  return (
    <>
      ...
      <footer className="relative z-40 backdrop-blur-sm border-t border-[var(--line)] mt-auto" style={{ backgroundColor: 'rgba(12, 35, 64, 0.8)' }}>
        <div className="w-full px-4 py-3 md:py-4 flex items-center justify-center">
          <div className="flex flex-wrap items-center justify-center gap-2 md:gap-4">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-[var(--text-muted)] hover:text-[var(--text)] transition-colors duration-200 text-xs md:text-sm font-medium px-2 md:px-3 py-1 rounded-lg hover:bg-[var(--surface-2)] flex items-center gap-2"
            >
            ...
            <button
              ...
              className={`flex items-center gap-2 text-[var(--text-muted)] hover:text-[var(--text)] transition-colors duration-200 text-xs md:text-sm font-medium px-2 md:px-3 py-1 rounded-lg hover:bg-[var(--surface-2)] ${
                hasApiKey() ? 'bg-green-900/30 border border-green-700/50' : 'bg-[var(--surface-2)] border border-[var(--line)]'
              }`}
            ...
            >
              ...
              {hasApiKey() ? (
                <span className="text-[var(--up)]">API Key</span>
              ) : (
                <span>API Key</span>
              )}
            </button>
