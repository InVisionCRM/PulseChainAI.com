...
export default function HeroSection() {
  ...
  return (
    <div className="min-h-screen relative w-full overflow-hidden bg-black flex flex-col items-center justify-center">
      ...
      >
        Made by <span className="text-white hover:text-blue-500 transition-colors cursor-pointer" onClick={() => window.open('https://superstake.win', '_blank')}>SuperStake.Win</span>
      </motion.p>
    </div>
  );
} 