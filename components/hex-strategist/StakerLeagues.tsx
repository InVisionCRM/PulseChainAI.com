...
function ShareStanding({ net, standing, live, rank, data, rates }: {
  ...
  const shareData = useMemo<StakerShareData>(() => {
    ...
    return {
      ...
      league: { key: live.league.key, name: live.league.name, color: live.league.color },
      next: live.next ? { key: live.next.key, name: live.next.name, color: live.next.color } : null,
