      ...
      <form onSubmit={handleSearch} className="flex items-center gap-2">
        <div className="relative flex-1 search-container">
          <input
            ...
            className="w-full h-8 px-3 pr-8 text-sm bg-[var(--panel)] border border-[var(--line)] rounded-lg text-[var(--text)] placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-cyan-500/50 focus:border-cyan-500"
          />
          <button
            type="submit"
            aria-label="Search"
