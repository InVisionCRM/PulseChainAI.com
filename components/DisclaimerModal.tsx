  ...
  return (
    <div className="fixed inset-0 bg-[var(--app-bg)] backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <motion.div
        ...
        className="bg-[var(--panel)] backdrop-blur-sm border border-[var(--line)] rounded-xl shadow-2xl max-w-2xl w-full max-h-[80vh] overflow-y-auto"
      >
        <div className="p-6">
          {/* Header */}
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-2xl font-bold text-[var(--text)]">⚠️ Important Disclaimer</h2>
            <button
              onClick={onClose}
          ...
          <div className="space-y-6 text-[var(--text-muted)]">
            ...
            <div>
              <h3 className="text-lg font-semibold text-[var(--text)] mb-3">🤖 AI Accuracy & Entertainment Purpose</h3>
            ...
            <div className="border-t border-[var(--line)] pt-6">
              <h3 className="text-lg font-semibold text-[var(--text)] mb-3">🧠 AI Therapist Disclaimer</h3>
              <div className="space-y-3 text-sm leading-relaxed">
                <p>
            ...
            <div className="border-t border-[var(--line)] pt-6">
              <h3 className="text-lg font-semibold text-[var(--text)] mb-3">💰 Crypto & Financial Disclaimer</h3>
              <div className="space-y-3 text-sm leading-relaxed">
                <p>
            ...
            {/* General Terms */}
            <div className="border-t border-[var(--line)] pt-6">
              <h3 className="text-lg font-semibold text-[var(--text)] mb-3">📋 General Terms</h3>
              <div className="space-y-3 text-sm leading-relaxed">
                <p>
          ...
          <div className="mt-8 pt-6 border-t border-[var(--line)] flex justify-end">
            <button
              onClick={onClose}
              className="bg-gradient-to-r from-[var(--app-bg)] to-[var(--app-bg)] hover:from-[var(--app-bg)] hover:to-[var(--app-bg)] text-[var(--text)] font-semibold py-3 px-6 rounded-lg transition-colors duration-200"
            >
              I Understand
            </button>
          </div>
