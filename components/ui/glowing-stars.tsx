...
export const GlowingStarsBackgroundCard = ({
  ...
  return (
    <div
      ...
      className={cn(
        "bg-[linear-gradient(110deg,#333_0.6%,#222)] p-4 max-w-md max-h-[20rem] h-full w-full rounded-xl border border-[#eaeaea] dark:border-[var(--line)]",
        className
      )}
    >
...
export const GlowingStarsDescription = ({
  ...
  return (
    <p className={cn("text-base text-[var(--text)] max-w-[16rem]", className)}>
      {children}
    </p>
  );
};
