      ...
      <div className="space-y-8">
        ...
        <div className="rounded-lg border border-[var(--line-strong)] bg-[var(--surface)] p-6">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div>
              <h4 className="font-semibold text-[var(--text)] mb-2">Use Cases:</h4>
            ...
            <div>
              <h4 className="font-semibold text-[var(--text)] mb-2">Real-world Examples:</h4>
              <ul className="text-sm text-[var(--text-muted)] space-y-1">
        ...
        <div className="rounded-lg border border-[var(--line-strong)] bg-[var(--surface)] p-6">
          <div className="flex items-center gap-4 mb-4">
            <IconBrandNextjs className="h-10 w-10 text-[var(--text)]" />
            <div>
              <h3 className="text-xl font-semibold text-[var(--text)]">Next.js API Routes</h3>
              <a
        ...
        <div className="rounded-lg border border-[var(--line-strong)] bg-[var(--surface)] p-6">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h3 className="text-xl font-semibold text-[var(--text)]">Python + FastAPI</h3>
              <a
        ...
        <div className="rounded-lg border border-[var(--line-strong)] bg-[var(--surface)] p-6">
          <div className="flex items-center gap-4 mb-4">
            <div className="h-10 w-10 bg-cyan-500 rounded text-sm flex items-center justify-center font-bold text-[var(--text)]">Go</div>
            <div>
              <h3 className="text-xl font-semibold text-[var(--text)]">Go + Gin</h3>
              <a
        ...
        <div className="rounded-lg border border-[var(--line-strong)] bg-[var(--surface)] p-6">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h3 className="text-xl font-semibold text-[var(--text)]">Rust + Axum</h3>
              <a
