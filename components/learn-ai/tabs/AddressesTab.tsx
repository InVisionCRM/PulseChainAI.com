    ...
    >
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          <h3 className="text-xl font-semibold text-[var(--text)]">DEX Router Contracts</h3>
          <div className="grid gap-4 md:grid-cols-2">
            <div className="rounded-lg border border-[var(--line-strong)] bg-[var(--surface)] p-4">
              <h4 className="font-semibold text-[#FA4616] mb-2">PulseX V1 Router</h4>
              <code className="block text-sm text-[var(--text)] bg-[var(--surface-2)] p-2 rounded">
        ...
        {/* Native Tokens */}
        <div className="space-y-4">
          <h3 className="text-xl font-semibold text-[var(--text)]">Native Tokens</h3>
          <div className="grid gap-4 md:grid-cols-2">
            <div className="rounded-lg border border-[var(--line-strong)] bg-[var(--surface)] p-4">
