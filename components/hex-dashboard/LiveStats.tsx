...
const LiveStats: React.FC<LiveStatsProps> = ({ 
  ...
  if (!liveData) {
    return (
      <div className="mb-6 bg-[var(--surface)] backdrop-blur-xl border border-[var(--line)] rounded-2xl shadow-[0_8px_30px_-12px_rgba(0,0,0,0.6)] p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
          {Array.from({ length: 6 }).map((_, i) => (
            <div key={i} className="text-center bg-[var(--surface)] backdrop-blur rounded-lg p-3 border border-[var(--line)] animate-pulse">
              <div className="h-8 bg-[var(--surface-2)] rounded mb-2"></div>
              <div className="h-4 bg-[var(--surface)] rounded"></div>
            </div>
          ))}
        </div>
      </div>
  ...
  return (
    <div className="mb-4 sm:mb-6 bg-[var(--surface)] backdrop-blur-xl border border-[var(--line)] rounded-xl sm:rounded-2xl shadow-[0_8px_30px_-12px_rgba(0,0,0,0.6)] p-3 sm:p-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-3 sm:mb-4">
        <h3 className="text-lg sm:text-xl font-bold text-[var(--text)] flex items-center gap-2 mb-2 sm:mb-0">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
          ...
          <button
            ...
            className="flex items-center gap-2 px-2 sm:px-3 py-1 bg-[var(--app-bg)] hover:bg-[var(--app-bg)] text-[var(--text)] text-xs sm:text-sm rounded-lg transition-colors self-start sm:self-auto"
          >
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-2 sm:gap-4 mb-4 sm:mb-6">
        ...
        <div className="text-center bg-[var(--surface-2)] rounded-lg p-2 sm:p-3 border border-[var(--line)]">
      ...
      <div className="border-t border-[var(--line)] pt-3 sm:pt-4">
        <h4 className="text-sm sm:text-md font-semibold text-[var(--text)] mb-2 sm:mb-3">
