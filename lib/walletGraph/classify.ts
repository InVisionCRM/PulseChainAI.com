...
> = {
  self: { label: 'This wallet', color: '#d9942f' },
  eoa: { label: 'Wallet (EOA)', color: '#7b84d4' },
  contract: { label: 'Contract', color: '#7d8799' },
  token: { label: 'Token', color: '#b06ba6' },
  pool: { label: 'DEX pool', color: '#3f9aa8' },
  router: { label: 'Router', color: '#3f9d83' },
  factory: { label: 'Factory', color: '#4faa92' },
  exchange: { label: 'Exchange', color: '#4684b8' },
  locker: { label: 'LP locker', color: '#c39a3b' },
  ofac: { label: 'OFAC flagged', color: '#c25b50' },
  burn: { label: 'Burn', color: '#6f7888' },
};
